...
class MainAppStyle {
  ...
  final Color bodyBG = Color.fromRGBO(230, 237, 253, 1);
  final Color headerBg = Color.fromRGBO(150, 0, 0, 1);
  ...
  ThemeData themeData = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Color.fromRGBO(150, 0, 0, 1), width: 2)),
      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.grey, width: 1)),
    ),
    switchTheme: SwitchThemeData(
      thumbColor: MaterialStateProperty.resolveWith((states) {
        if (states.contains(MaterialState.selected)) {
          return Color.fromRGBO(150, 0, 0, 1); // červený pri ON
        }
